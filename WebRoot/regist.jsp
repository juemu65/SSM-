...
<div id="reg">
  ...
  <form method="post" action="reg.do" onsubmit="return check();">
    <ul>
      ...
      <li class="r" >
        ...
        <span id='checku2' class="spanInit" ></span></li>
           <!--  <li class="m">学历： </li>
      <li class="r" >
      <select name="xueli" class="box txtInit">
        ...
        <span id='checku' class="spanInit" ></span></li>   -->
         <!--  <li class="m">专业： </li>
      <li class="r" >
        <input name="profession" type="text" class="box txtInit" id="profession" onblur="return checkuname3()" />
        <span id='chec' class="spanInit" ></span></li>
            <li class="m">工作经验：</li>
      <li class="r" >
        <select name="experience" class="box txtInit">
    ...
    <li class="m">问题答案 <input name="utype" type="hidden" value="会员" /></li>
     ...
     <!-- <li class="m">个人介绍： <input name="utype" type="hidden" value="会员" /> </li>
      <li class="r">
      <textarea rows="5" cols="80" name="introduction" class="txtInit jies">
      </textarea> </li> -->
      <li class="m"> </li>
      <li class="r zhuc">
