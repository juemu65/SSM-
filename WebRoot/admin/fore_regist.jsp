...
<div id="menu">
  <div id="menu-m">
    <ul>
      <li><a href="DoTypeServlet">首页</a></li>
      <li style="width:8px;"><img src="images/t1.jpg" width="8" height="42" /></li>
      <li><a href="DoOutsideServlet?type=2">境内游</a></li>
      <li style="width:8px;"><img src="images/t1.jpg" width="8" height="42" /></li>
      <li><a href="DoOutsideServlet?type=1">境外游</a></li>
      <li style="width:8px;"><img src="images/t1.jpg" width="8" height="42" /></li>
      <li><a href="#">热门游</a></li>
      <li style="width:8px;"><img src="images/t1.jpg" width="8" height="42" /></li>
      <li><a href="ShowTeamTopThreeServlet">团购</a></li>
      <li><a href="ShowCartServlet?n=2" ><img src="images/che.jpg" width="176" height="42" /></a></li>
    </ul>
  </div>
</div>
<!--广告位图片-->
...
<div id="reg">
  ...
  <form  action="RegServlet" method="post" onsubmit="return check()">
    <ul>
      ...
      <li class="m">身份证号 </li>
      <li class="r">
        <input name="identityid" type="text" class="box txtInit" id="id" onblur="return checkid()" /><div id="checkid" style="display:inline;color:red;font-family:楷体;font-size:15px"></div>
