$(function(){
	...
	$('.banner').each(function(){
		...
		var jiazhengs=e.attr("data-jiazheng");
		var jiazhengs_s=e.attr("data-small");
		var jiazhengs_m=e.attr("data-middle");
		var jiazhengs_b=e.attr("data-big");
		var num=e.find(".carousel .jiazheng").length;
		var win=$(window).width();
		var i=1;

		if(interval==null){interval=5};
		if(jiazhengs==null || jiazhengs<1){jiazhengs=1};
		if(jiazhengs_s!=null && win>760){jiazhengs=jiazhengs_s};
		if(jiazhengs_m!=null && win>1000){jiazhengs=jiazhengs_m};
		if(jiazhengs_b!=null && win>1200){jiazhengs=jiazhengs_b};

		var jiazhengWidth=Math.ceil(e.outerWidth()/jiazhengs);
		var page=Math.ceil(num/jiazhengs);
		e.find(".carousel .jiazheng").css("width",jiazhengWidth+ "px");
		e.find(".carousel").css("width",jiazhengWidth*num + "px");
		
		var carousel=function(){
			i++;
			if(i>page){i=1;}
			$showbanner(e,i,jiazhengs,num);
		};
		...
		if(pointer!=0 && page>1){
			...
			pager.find("li").click(function(){
				$showbanner(e,$(this).val(),jiazhengs,num);
			});
	...
	$showbanner=function(e,i,jiazhengs,num){
		var after=0,leftx=0;
		leftx = - Math.ceil(e.outerWidth()/jiazhengs)*(jiazhengs)*(i-1);
		if(i*jiazhengs > num){after=i*jiazhengs-num;leftx= - Math.ceil(e.outerWidth()/jiazhengs)*(num-jiazhengs);};
