  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="add_addr.jsp"> 添加内容</a> </li>
        <li>
          </li>
      </ul>
    </div>
    ...
    <c:forEach items="${list }" var="t">
        <tr>
          ...
          <%--  <a class="button border-main" href="doUpdateAddr.do?id=${t.fid }"><span class="icon-edit"></span> 修改</a>  --%>
          <a class="button border-red" href="deleteAddr.do?id=${t.fid }" onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 删除</a> </div></td>
        </tr>
       </c:forEach>
