...
<script type="text/javascript" src="/jiazheng/js/WdatePicker.js"></script>
<script language="JavaScript" src="/jiazheng/admin/js/FusionCharts.js"></script>
<script type="text/javascript" src="js/jquery-1.11.0.min.js"></script>
<script type="text/javascript" src="js/jquery-1.8.3.min.js"></script>
<script type="text/javascript" src="/jiazheng/admin/js/Date.js"></script>
...
var chart = new FusionCharts("/jiazheng/admin/js/FCF_Line.swf", "ChartId", "900", "300");
  	 function tj() {
       var id=$("#id").val();
		var start = $("#key").val();
		var end=$("#key1").val();
