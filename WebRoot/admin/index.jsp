...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top" style="color:#000;">
    <h1><img src="images/y.jpg" class="radius-circle rotate-hover" height="50" alt="" />家政服务网</h1>
  </div>
  <div class="head-l"><a class="button button-little bg-green" href="http://localhost:8080/jiazheng/showIndex.do" target="_blank"><span class="icon-home"></span> 前台首页</a> &nbsp;&nbsp;
...
<div class="leftnav">
  ...
  <ul>
    <li><a href="newsList.do" target="right"><span class="icon-caret-right"></span>广告图片管理</a></li>        
  </ul> 
  </c:if>
   <h2><span class="icon-pencil-square-o"></span>服务管理</h2>
  <ul>
  <li><a href="fAddrList.do" target="right"><span class="icon-caret-right"></span>服务类型管理</a></li> 
  <li><a href="FuWuList.do" target="right"><span class="icon-caret-right"></span>服务管理</a></li>
