...
<form method="post" action="addBbsFore">
  <div id="reg-top">&nbsp;&nbsp;&nbsp;&nbsp;留言</div>
 <div id="reg-mleft">
  
    <ul>
      <li class="m">标题：</li>
      <li class="r" >
        <input name="bbs.name" type="text" class="box txtInit" id="txtNo" />
        <input name="bbs.gid" type="hidden" value="<s:property value="goods.qid" />" />
      ...
      <li class="r"><input name="button" type="submit" id="button" value="提交"  
