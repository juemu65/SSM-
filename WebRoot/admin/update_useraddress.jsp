...
<div id="reg">
  ...
  <div id="reg-top">&nbsp;&nbsp;&nbsp;&nbsp;修改常用人和地址</div>
  <div id="reg-mleft">
  <form onsubmit="return check()" method="post" action="updateuseraddress">
    <ul>
      <li class="m">姓名 </li>
      <li class="r" >
        <input name="ps.uname" type="text" class="box txtInit" value="<s:property value="ps.uname" />" />
        <span id='checku' class="spanInit" >
        <input name="ps.pid" type="hidden" class="box txtInit"  value="<s:property value="ps.pid" />" />
        </span></li>
      <li class="m">地址 </li>
      <li class="r">
      
        <input name="" type="text" class="box txtInit" id="txtPwd" value="<s:property value="ps.uaddress" />" readonly="readonly"/>
